"""
Django settings for tecnoglasscrud project.
...
SECRET_KEY = 'django-insecure-7b2ez*y49__n6z-q%da_2n73vhg-%)41g(_fqbhqp@ia0wa95@'
...
WSGI_APPLICATION = 'tecnoglasscrud.wsgi.application'
